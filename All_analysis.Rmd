...
```{r}
hist(media_ratings$Science_enjoy)
```
```{r}
hist(media_ratings$Docu_enjoy)
```

```{r}
hist(media_ratings$Movie_enjoy)
```
```{r}
hist(media_ratings$Puzzle_enjoy)
```

```{r}
hist(media_ratings$Game_enjoy)
```

```{r}
demo = read.csv("Data/Study1_democsv.csv")
```
