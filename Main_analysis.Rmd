...
```{r}
# manipulation check
S3_h1 = lmer(scale(appeal) ~ scale(insight) + (1|participant_id) + (1|explanation_id), data = data_Klopfenstein)
...
S3_h2 = lmer(scale(appeal) ~ scale(insight)*factor(topic_name) + (1|participant_id) + (1|explanation_id), data = data_Klopfenstein)
